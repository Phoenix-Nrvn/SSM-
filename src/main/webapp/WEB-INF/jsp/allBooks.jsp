            ...
            <table class="table table-hover table-striped">
                ...
                <c:forEach var="books" items="${list}">
                    <tr>
                        ...
                        <td>${books.detail}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/book/toUpdateBooks/${books.bookId}">修改书籍</a>
                            &nbsp; | &nbsp;
                            <a href="${pageContext.request.contextPath}/book/deleteBooks/${books.bookId}">删除书籍</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
